...
{
    public class OrderBuyFromFactoryProfile : Profile
    {
        public OrderBuyFromFactoryProfile()
        {
            CreateMap<OrderBuyFromFactoryVM, Domain.Entities.Product.OrderBuyFromFactory>()
            ...
            CreateMap<Domain.Entities.Product.OrderBuyFromFactory, OrderBuyFromFactoryVM>()
