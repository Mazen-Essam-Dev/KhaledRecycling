...
{
    public class QuartersReportCollaborativeDetailsVM
    {
        ...
        public MonthsOfYearsAnnualyActivitiesAndAdministrative? MonthsOfYearsAnnualyActivitiesAndAdministrativeVM { get; set; }
