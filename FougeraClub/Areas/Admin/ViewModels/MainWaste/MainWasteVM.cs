...
namespace KhaledTeamRecycling.Areas.Admin.ViewModels.MainWaste
{
    public class MainWasteVM
    {
        // index data
        ...
        public IEnumerable<Domain.Entities.Waste.MainWaste>? Items { get; set; }
